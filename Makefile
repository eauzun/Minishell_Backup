...
SRC = main.c src/env_data.c src/signals.c \
	...
	executor/executor.c executor/executor2.c executor/executor3.c  executor/executor4.c executor/executor_redir.c \
	executor/executor_pipe.c executor/executor_pipe_free_utils.c executor/pipe_child_process.c executor/pipe_child_executor.c\
	executor/pipe_pipeline_setup.c executor/executor_heredoc.c executor/executor_heredoc_utils.c executor/executor_heredoc_utils2.c \
	...
	utils/utils.c utils/utils2.c utils/utils3.c utils/ft_split.c utils/numeric_atoll.c
