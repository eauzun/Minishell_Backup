...
SRC = main.c src/env_data.c src/signals.c \
		...
		executor/executor_heredoc.c executor/executor_heredoc_utils.c parser/parser_free_utils.c executor/executor.c executor/executor2.c executor/executor3.c executor/executor4.c
