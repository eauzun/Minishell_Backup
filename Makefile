...
SRC = main.c src/env_data.c src/signals.c src/cleanup.c \
		...
		executor/executor.c executor/executor_redir.c executor/executor_builtin.c executor/executor_utils.c executor/executor_path.c \
		...
		utils/utils.c utils/utils1.c utils/utils2.c utils/utils3.c executor/pipe.c executor/pipe2.c  executor/pipe3.c
